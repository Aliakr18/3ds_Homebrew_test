...
#define TOP_RIGHT_FRAME1 0x10400494
#define TOP_RIGHT_FRAME2 0x10400498
#define SUB_LEFT_FRAME1 539039967
#define SUB_LEFT_FRAME2 539039968
...
void write_color3(int address3, char r, char g, char b);
